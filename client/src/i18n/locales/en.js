const en = {
  ...
  tutorial: {
    ...
    viewsDesc: 'Switch between Kanban, Calendar, and Graph views using the selector in the header to visualize your project from different perspectives.',
    contextMenu: 'Contextual Actions',
    contextMenuDesc: 'Right-click on any card to instantly move it to another column, set priority, or copy its link without opening the full modal.',
    hotkeys: 'Power User Hotkeys',
    hotkeysDesc: 'Use keyboard shortcuts like "1", "2", "3" to switch views, or "Ctrl+K" for quick navigation. See the help menu for the full list.',
    ...
    customizeDesc: 'Upload an avatar, choose a board background, customize your profile. The app is available in multiple languages.',
