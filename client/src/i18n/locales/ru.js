const ru = {
  ...
  board: {
    ...
    cardTitlePlaceholder: 'Введите название задачи...',
  ...
  // ===== ТУТОРИАЛ =====
  tutorial: {
    welcome: 'Добро пожаловать в TaskBoard!',
    welcomeDesc: 'TaskBoard — это инструмент для управления задачами в команде. Давайте быстро разберёмся, как всё работает.',
    createBoard: 'Создайте доску',
    createBoardDesc: 'Доска — это ваш проект. Нажмите "Создать доску" на главной. Каждая доска содержит колонки и карточки задач.',
    dragDrop: 'Перетаскивайте задачи',
    dragDropDesc: 'Перетащите карточку из одного столбца в другой, чтобы обновить статус задачи. Можно также перетаскивать сами столбцы.',
    cards: 'Настраивайте карточки',
    cardsDesc: 'Кликните на карточку, чтобы добавить описание, приоритет, чек-лист, метки и назначить исполнителей.',
    views: 'Разные режимы просмотра',
    viewsDesc: 'Переключайтесь между Канбан-доской, Календарем и Графом в шапке сайта, чтобы взглянуть на проект под другим углом.',
    contextMenu: 'Контекстные действия',
    contextMenuDesc: 'Нажмите правой кнопкой мыши по любой карточке для быстрого перемещения, смены приоритета или копирования ссылки.',
    hotkeys: 'Горячие клавиши',
    hotkeysDesc: 'Используйте "1", "2", "3" для смены видов или "Ctrl+K" для быстрого поиска. Полный список доступен в меню справки.',
    collaborate: 'Работа в команде',
    collaborateDesc: 'Приглашайте коллег по коду или поиску. Все изменения синхронизируются мгновенно у всех участников.',
    customize: 'Персонализация',
    customizeDesc: 'Загружайте аватар, выбирайте фон досок, настраивайте профиль. Приложение доступно на многих языках.',
  ...
  profile: {
    ...
    // Видимость у доски
    boardPreferences: 'Настройки доски',
    showDescPreview: 'Показывать описание на карточках',
    showDescPreviewDesc: 'Отображать превью описания прямо на карточках доски',
  ...
  hotkeys: {
    ...
    toggleMembers: 'Панель участников',
    invite: 'Пригласить',
    boardSettings: 'Board settings',
    showHelp: 'Show this help',
    openNewTab: 'Open in new tab',
    views: 'Виды',
    viewKanban: 'Вид: Канбан',
    viewCalendar: 'Вид: Календарь',
    viewGraph: 'Вид: Граф',
  },

  column: {
    rename: 'Переименовать',
    changeColor: 'Цвет столбца',
    collapse: 'Свернуть',
    duplicate: 'Дублировать',
