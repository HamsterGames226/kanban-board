const ru = {
  ...
  tutorial: {
    ...
    createBoardDesc: 'Доска — это ваш проект. Нажмите "Создать доску" на главной странице. Каждая доска содержит столбцы и карточки задач.',
    ...
    cardsDesc: 'Нажмите на карточку, чтобы добавить описание, приоритет, чеклист, метки, срок выполнения и исполнителей.',
    collaborate: 'Работайте в команде',
    collaborateDesc: 'Пригласите коллег по коду или поиску. Все изменения обновляются в реальном времени для всех участников.',
    customize: 'Персонализируйте',
    customizeDesc: 'Загрузите аватарку, выберите фон доски, настройте профиль. Приложение доступно на русском и английском языках.',
